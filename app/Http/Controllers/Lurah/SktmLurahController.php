...
class SktmLurahController extends Controller
{
    /**
    ...
    {
        if (request()->ajax()) {
            $query = Letter::where('jenis_surat', 'SKTM')->where('posisi', 'lurah')->orderBy('created_at', 'DESC');
            ...
            return datatables()->of($query)
                ...
                ->editColumn('action', function ($item) {
                    if ($item->posisi == 'lurah') {
                        return '
                            <a href="#" class="btn btn-sm btn-secondary" onclick="lampiranSktmLurah(' . $item->id . ')">
                                <i class="fa fa-eye"></i>
                            </a>
