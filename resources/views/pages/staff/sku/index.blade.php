                    ...
                    <div class="card-body">
                        <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                            <li class="nav-item" role="presentation">
                                <a href="#skubelumproses" onclick="skuBelumProses()" class="nav-link active" id="pills-belum-diproses-tab" data-toggle="pill"
                            ...
                            <li class="nav-item" role="presentation">
                                <a href="#skusedangproses" onclick="skuSedangProses()" class="nav-link" id="pills-sedang-diproses-tab" data-toggle="pill"
                            ...
                            <li class="nav-item" role="presentation">
                                <a href="#skuselesaiproses" onclick="skuSelesaiProses()" class="nav-link" id="pills-selesai-diproses-tab" data-toggle="pill"
