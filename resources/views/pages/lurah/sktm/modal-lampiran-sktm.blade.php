<!-- Modal -->
<div class="modal fade" id="lampiranSktmModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
	aria-hidden="true">
					...
					<div class="row">
						...
						<div class="col-12 col-lg-4">
							<div class="form-group">
								...
								<input type="text" class="form-control" id="perkawinan" readonly>
							</div>
						</div>
					</div>
					...
					<div class="row">
						...
						<div class="col-12 col-lg-4">
							<div class="form-group">
								...
								<input type="text" class="form-control" id="rt_rw" readonly>
							</div>
						</div>
					</div>
					...
					<div class="row">
						...
						<div class="col-12 col-lg-6">
							<div class="form-group">
								...
								<input type="text" class="form-control" id="tujuan_surat_tidak_mampu" readonly>
							</div>
						</div>
					</div>
