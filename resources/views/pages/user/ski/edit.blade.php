                            ...
                            <div class="row">
                                ...
                                <div class="col-12 col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="tujuan_surat" name="tujuan_surat" value="{{ $item->tujuan_surat }}">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-12 col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <input type="time" class="form-control" id="waktu_izin" name="waktu_izin" value="{{ $item->waktu_izin }}">
                                    </div>
                                </div>
                                <div class="col-12 col-lg-4">
                                    <div class="form-group">
                                        <label for="tempat_izin">Tempat Pelaksanaan</label>
                                        <input type="text" class="form-control" id="tempat_izin" name="tempat_izin" value="{{ $item->tempat_izin }}">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-12 col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="hiburan" name="hiburan" value="{{ $item->hiburan }}">
                                    </div>
                                </div>
                                <div class="col-12 col-lg-4">
                                    <div class="form-group">
