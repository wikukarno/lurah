                    ...
                    <div class="card-body">
                        <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                            <li class="nav-item" role="presentation">
                                <a onclick="skiBelumProses()" href="#" class="nav-link active" id="pills-belum-diproses-tab" data-toggle="pill"
                            ...
                            <li class="nav-item" role="presentation">
                                <a onclick="skiSedangProses()" href="#" class="nav-link" id="pills-sedang-diproses-tab" data-toggle="pill"
                            ...
                            <li class="nav-item" role="presentation">
                                <a onclick="skiSelesaiProses()" href="#" class="nav-link" id="pills-selesai-diproses-tab" data-toggle="pill"
                            ...
                            <li class="nav-item" role="presentation">
                                <a onclick="skiDitolak()" href="#" class="nav-link" id="pills-ditolak-tab" data-toggle="pill"
                        ...
                        <div class="tab-content" id="pills-tabContent">
                            <div class="tab-pane fade show active" id="pills-belum-diproses" role="tabpanel"
                                ...
                                <div class="table-responsive">
                                    <table id="tb_ski_user_belum_diproses"
                            ...
                            <div class="tab-pane fade" id="pills-sedang-diproses" role="tabpanel"
                                ...
                                <div class="table-responsive">
                                    <table id="tb_ski_user_sedang_diproses"
                                        class="table table-hover scroll-horizontal-vertical w-100">
                                        <thead>
                                            <tr>
                                                <th>No.</th>
                            ...
                            <div class="tab-pane fade" id="pills-selesai-diproses" role="tabpanel"
                                ...
                                <div class="table-responsive">
                                    <table id="tb_ski_user_selesai_diproses"
                                        class="table table-hover scroll-horizontal-vertical w-100">
                                        <thead>
                                            <tr>
                                                <th>No.</th>
...
<script>
    $('#tb_ski_user_belum_diproses').DataTable({
    processing: true,
    serverSide: true,
    ordering: [[1, 'asc']],
    ajax: {
    ...
    $('#tb_ski_user_sedang_diproses').DataTable({
    processing: true,
    serverSide: true,
    ordering: [[1, 'asc']],
    ajax: {
    url: "{{ route('ski-user.onProgress') }}",
    },
    columns: [
    { data: 'DT_RowIndex', name: 'id' },
    { data: 'user.nama', name: 'user.nama' },
    ...
    $('#tb_ski_user_selesai_diproses').DataTable({
    processing: true,
    serverSide: true,
    ordering: [[1, 'asc']],
    ajax: {
    url: "{{ route('ski-user.success') }}",
    },
    columns: [
    { data: 'DT_RowIndex', name: 'id' },
    { data: 'user.nama', name: 'user.nama' },
    ...
    $('#tb_ski_user_ditolak').DataTable({
    processing: true,
    serverSide: true,
    ordering: [[1, 'asc']],
    ajax: {
    url: "{{ route('ski-user.rejected') }}",
    },
    columns: [
    { data: 'DT_RowIndex', name: 'id' },
    { data: 'user.nama', name: 'user.nama' },
