                ...
                <div class="card">
                    <div class="card-header">
                        <div class="header-title">
                            <h3 class="card-title">Daftar Surat Selesai Diproses</h3>
                        </div>
                    </div>
                    <div class="card-body">
                        <div class="table-responsive">
                            <table id="tb_user_surat_selesai_dashboard"
...
@push('after-scripts')
<script>
    $('#tb_user_surat_selesai_dashboard').DataTable({
        processing: true,
        serverSide: true,
        ordering: [[1, 'asc']],
        ajax: {
            url: "{{ route('user.show-surat-selesai-dashboard') }}",
        },
        columns: [
