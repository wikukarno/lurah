            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                            ...
                            <div class="col-12 col-lg-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control"
                                        value="{{ \Carbon\Carbon::parse($item->tanggal_meninggal)->isoFormat('D MMMM Y') }}"
                                        readonly>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-12 col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" value="{{ $item->tempat_pemakaman }}"
                                        readonly>
                                </div>
                            </div>
                            <div class="col-12 col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control"
                                        value="{{ \Carbon\Carbon::parse($item->tanggal_dimakamkan)->isoFormat('D MMMM Y') }}"
                                        readonly>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-12 col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" value="{{ $item->tempat_lahir }}" readonly>
                                </div>
                            </div>
                            <div class="col-12 col-lg-6">
                                <div class="form-group">
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" value="{{ $item->pekerjaan }}" readonly>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-lg-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" value="{{ $item->agama }}" readonly>
                                </div>
                            </div>
                            <div class="col-12 col-lg-4">
                                <div class="form-group">
                                    <label for="nama">Kecamatan</label>
                                    <input type="text" class="form-control" value="{{ $item->kecamatan }}" readonly>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-12 col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" value="{{ $item->kelurahan }}" readonly>
                                </div>
                            </div>
                            <div class="col-12 col-lg-6">
                                <div class="form-group">
                                    <label for="nama">RT / RW</label>
                                    <input type="text" class="form-control" value="{{ $item->rtrw }}" readonly>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row mt-3">
                            <div class="col-12 col-lg-12">
                                <a href="{{ route('skp-user.index') }}" class="btn btn-danger btn-block">Kembali</a>
                            </div>
                        </div>
                    </div>
                </div>
